...
def setup(protocol):
    # equipment
    global trash, pipette, tips1000, tips1000_1, empty_tiprack, tips1000_24well, tips24_adapter, buff, plate
    ...
    buff = protocol.load_labware('nest_1_reservoir_195ml', 'B2')
    plate = protocol.load_labware('thomsoninstrument_24_wellplate_10400ul', 'C2')
