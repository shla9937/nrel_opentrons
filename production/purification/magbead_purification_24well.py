...
metadata = {
    ...
    'description': '''Purify protein from 24 well plate using StrepXT mag beads, doesn't clean beads.''',
    'apiLevel': '2.20'}
...
def lyse(protocol):
    ...
    p1000.pick_up_tip()
    for well in range(0,24):
        p1000.transfer(150, beads, well24.wells()[well].top(), new_tip="never", mix_before=(5, 1000))
    p1000.drop_tip()
